---
title: "06 Maximum likelihood by hand"
author:
...
output:
  prettydoc::html_pretty:
    ...
    toc_depth: 2
vignette: |
  %\VignetteIndexEntry{06 Maximum likelihood by hand}
...
The data is the same as in the vignette _01 Estimating phylogenetic trees with phangorn_:
```{r load packages}
library(ape)
library(phangorn)
...
## Bootstrap
At last we may want to apply standard bootstrap to test how well the edges of the tree are supported. This has already been shown in the vignette _01 Estimating phylogenetic trees with phangorn_. 
