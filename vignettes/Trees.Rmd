...
## <a name="start"></a> 2. Getting started
...
## <a name="dist"></a> 3. Distance based methods
...
## <a name="ml"></a> 5. Maximum likelihood
...
## <a name="model"></a> 6. Model selection
...
## <a name="session"></a> 8 Session info {.unnumbered}

```{r sessionInfo, echo=FALSE}
sessionInfo()
```

## <a name="ref"></a> 9. References
