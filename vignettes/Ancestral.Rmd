...
2. [ Parsimony reconstructions ](#pars)
3. [ Likelihood reconstructions ](#ml)
4. [ Session info ](#session)
5. [ References ](#ref)
...
## <a name="pars"></a> 2. Parsimony reconstructions 
...
## <a name="ml"></a> 3. Likelihood reconstructions
...
## <a name="session"></a> 4. Session info 

```{r sessionInfo, echo=FALSE}
sessionInfo()
```

## <a name="ref"></a> 5. References 
