...
The functions `read.nexus.networx` and `write.nexus.networx` can read and write nexus files to exchange networks SplitsTree [@Huson2006]. Not all the features of the network block in the files are yet supported. 
